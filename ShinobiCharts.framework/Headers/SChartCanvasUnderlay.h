...
-(void)drawLinesForXCoords:(NSArray*)xCoords andYCoords:(NSArray*)yCoords withColor:(UIColor*)color andWidth:(CGFloat)width;
-(void)drawLinesForXCoords:(NSArray*)xCoords andYCoords:(NSArray*)yCoords withColor:(UIColor*)color andWidth:(CGFloat)width andDashStyle:(NSArray *)dashes;
